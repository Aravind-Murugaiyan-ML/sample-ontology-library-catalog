 ...
 * [lco.yml](lco.yml)
     * Determines how your purl.obolibrary.org/obo/lco/ redirects will be handled
     ...
     * Paste in the contents of [lco.yml](lco.yml)
 ...
 * [lco.md](lco.md)
     ...
     * Paste in the contents of [lco.md](lco.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
