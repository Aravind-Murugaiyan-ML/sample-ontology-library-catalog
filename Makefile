...
setup-remote:
	...
	@git remote add origin git@github-Aravind-Murugaiyan-ML:Aravind-Murugaiyan-ML/sample-ontology-library-catalog.git
...
push-initialized-repo-to-main-branch:
	@echo "Pushing ontology seeded by ODK"
